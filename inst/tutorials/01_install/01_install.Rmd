...
This tutorial will help you set up R and Rstudio on your own computer. 

You should complete this tutorial if you want to:
  
* Install R on your computer
* Install the RStudio integrated development environment (IDE)
* Install the `tidyverse` R package

You can skip this tutorial if you've already done these things. If you are working in RStudio Cloud, then you do not need to (but should still learn how to) install R and the RStudio IDE.
...
```{r quiz1, }
question(
  "Check all that you have NOT done:",
  ...
  answer(
    "None of the above. I've done them all.",
    correct = TRUE,
...
RStudio is an **I**ntegrated **D**evelopment **E**nvironment (IDE) for R. 

What does that mean? Well, if you think of R as a language, you can think of RStudio as a program that helps you speak the language. RStudio makes programming in R much easier and I highly recommend it.
...
If you'd like a little more detail and explanation of the Rstudio IDE, you can find an excellent chapter in this [free textbook](https://bookdown.org/ndphillips/YaRrr/the-four-rstudio-windows.html)
